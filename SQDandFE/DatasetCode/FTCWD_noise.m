function [TFD,t,f] = FTCWD_noise(x,t,N,g,h,sigma,trace,sizeImg)
% function  FTCWD(x,t,N,g,h,sigma,trace,sizeImg)
...
% TFD = tfr;
% 
% img = normalize(abs(tfr),'range',[0 255]);
img =rescale(abs(tfr), 0, 255);
TFD = uint8(imresize(img,[224 448]));
TFD = TFD(:,225:448);
