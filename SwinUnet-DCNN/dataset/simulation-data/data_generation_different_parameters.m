...
A = 1;                                       % amplitude 
waveforms = {'BPSK','Costas','Frank','LFM','P1','P2','P3','P4','T1','T2','T3','T4'}; %12 LPI waveform codes 
...
for n = 1 : length(SNR)
    ...
    datasetCWD = ['test_dataset_different_parameters\',num2str(SNR(n)),'db'];
        ...
        switch waveform                                           
            ...
            case 'LFM'  
                ...
                for idx = 1:fps 
                    ...
                    wav = type_LFM(N(idx),fs,A,fc(idx),B(idx),sweepDirections{randi(2)}); % 调用type_LFM函数 返回s值
                    wav = awgn(wav,SNR(n),'measured');
