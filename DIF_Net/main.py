...
# 用的含有十二种调制类型和方位角信息的数据集 单只测方位角估计部分的消融实验
# 设置随机种子
...
def test_joint_latent_full():
    ...
    # concat
    # model_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0710/model/joint_latent_joint/best_model_joint.pth'
    # nocross
    # model_path ='/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0710/model/joint_latent_woFreqjoint/best_model_joint.pth'
     # adaptive
    # model_path ='/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/model2/joint_latent_AdaptiveFusionjoint/best_model_joint.pth'
    #JointNet_AdaptiveFusion_woTrans
    model_path ='/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/model2/joint_latent_AdaptiveFusionnotransjoint/best_model_joint.pth'
    

    # model_path='/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0710/model/joint_latentnoglobalcontex_joint/best_model_joint.pth'
...
def test_joint_latent_scatter():
    ...
    test_data_path = (
        ...
        "CDMT-Net_0718/testdataset"
    )

    model_path = (
        "/home/sp432sl/ZQ/DOA_regcition_0908/"
        "CDMT-Net_0718/model2/"
    ...
    save_dir = (
        "/home/sp432sl/ZQ/DOA_regcition_0908/"
        "CDMT-Net_0718/allaccrmse/scatter"
    )
    ...
    # ==========================================================
    # 9. 设置绘图字体
    # 与原始 plt.figure(figsize=(6, 6)) 的默认样式保持一致
    # ==========================================================
    plt.rcParams.update(
        {
...
def test_joint_latent_full_generalized():
    ...
    # 测试数据路径（可修改）
    # test_data_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/testdataset'
    test_data_path ='/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/diffM/M10'
    #M=8"
    # test_data_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/datasetdifffsnap/-20.25/256'
    # model_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/model2/joint_latent_AdaptiveFusionjoint/best_model_joint.pth'

    #M=7
    # test_data_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/datasetdifffsnap/5.1/4482'
    model_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/model2/joint_latent_AdaptiveFusionjoint/best_model_joint.pth'
    # os.makedirs(result_dir, exist_ok=True)
...
def test_joint_latent_full_allresult():
    ...
    test_data_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/testdataset'
    model_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/model2/joint_latent_AdaptiveFusionjoint/best_model_joint.pth'
    save_dir = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/allaccrmse'
    os.makedirs(save_dir, exist_ok=True)
...
def generate_confusion_matrices(snr_list=[-8, -4, 0]):
    ...
    test_data_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/testdataset'
    model_path = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/model2/joint_latent_AdaptiveFusionjoint/best_model_joint.pth'
    result_dir = '/home/sp432sl/ZQ/DOA_regcition_0908/CDMT-Net_0718/allaccrmse/confusion'
...
if __name__ == "__main__":
    ...
    # main_jointnet_wofreq(mode='joint')
    
    #===== 消融实验
    # test_model_doa() #doa的基线
    # test_model_mod()
    # test_joint_latent_full()#隐式
    # test_joint_latent_full_allresult()
    # test_joint_latent_full_generalized()
    # test_jointnet_wofreq()
    # test_joint_doa() #用的真实的fc标签看fc对DOA的影响
    # test_jointnet_doafreq() #看是否必须是这个MOD支路
...
#    generate_confusion_matrices(snr_list=[-8, -4, 8])
    ...
    # main_joint_fc_mod()
    # test_fc_only_model()
    # test_joint_model_fc_mod()
    # test_joint_model_fc_mod_generalized()

    # test_joint_latent_full_generalized_from_mat()
